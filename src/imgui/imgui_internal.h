...
#define IMGUI_DEBUG_LOG_SELECTION(...)  ((void)0)
...
#define IM_DRAWLIST_CIRCLE_AUTO_SEGMENT_MIN                     100
...
namespace ImGui
{
    ...
    inline const char*      LocalizeGetMsg(ImGuiLocKey key) { ImGuiContext& g = *GImGui; const char* msg = g.LocalizationTable[key]; return msg ? msg : _( "*Missing Text*" ); }
